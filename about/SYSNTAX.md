...
данной директории и запускает его. ТАкой же результат можно достичь и с помощью "вычитать" и "русить".
...
Фильтр является тем, чем он называется, а перебор это map (в python) или select (в C#).
